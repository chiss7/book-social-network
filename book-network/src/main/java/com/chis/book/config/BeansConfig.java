...
public class BeansConfig {
    ...
    /**
     * Defines the PasswordEncoder bean for encoding and validating user passwords.
     * This uses BCrypt, a strong hashing algorithm that is recommended for password storage.
     * @return PasswordEncoder bean for encoding user passwords
     */
    @Bean
